...
export function generateDemoData() {
  ...
  const ips: IPBlockRecord[] = [
    { id: generateId(), name: "USB3_PHY", technologyId: techIds["N5"], startDate: today.format("YYYY-MM-DD"), ddlDate: today.add(45, "day").format("YYYY-MM-DD"), extendedDdlDate: null, extensions: [{ date: today.add(60, "day").format("YYYY-MM-DD"), reason: "等待EMX寄生" }], notes: "USB 3.2 Gen2", chipTagIds: [chipTags[0].id, chipTags[1].id], status: "in_progress", isDemo: true, createdAt: now, updatedAt: now },
    { id: generateId(), name: "DDR5_CTRL", technologyId: techIds["N3"], startDate: today.add(-15, "day").format("YYYY-MM-DD"), ddlDate: today.add(30, "day").format("YYYY-MM-DD"), extendedDdlDate: null, extensions: [], notes: "DDR5 controller", chipTagIds: [chipTags[1].id], status: "in_progress", isDemo: true, createdAt: now, updatedAt: now },
    { id: generateId(), name: "PCIE6_PHY", technologyId: techIds["N5"], startDate: today.add(10, "day").format("YYYY-MM-DD"), ddlDate: today.add(80, "day").format("YYYY-MM-DD"), extendedDdlDate: null, extensions: [], notes: "PCIe 6.0", chipTagIds: [chipTags[2].id], status: "pending", isDemo: true, createdAt: now, updatedAt: now },
    { id: generateId(), name: "MIPI_DSI", technologyId: techIds["N7"], startDate: today.add(-30, "day").format("YYYY-MM-DD"), ddlDate: today.add(20, "day").format("YYYY-MM-DD"), extendedDdlDate: null, extensions: [], notes: null, chipTagIds: [], status: "completed", isDemo: true, createdAt: now, updatedAt: now },
    { id: generateId(), name: "SATA_CTRL", technologyId: techIds["N5"], startDate: today.add(20, "day").format("YYYY-MM-DD"), ddlDate: today.add(70, "day").format("YYYY-MM-DD"), extendedDdlDate: null, extensions: [], notes: "SATA controller", chipTagIds: [chipTags[0].id], status: "pending", isDemo: true, createdAt: now, updatedAt: now },
    { id: generateId(), name: "HDMI_TX", technologyId: techIds["N3"], startDate: today.add(-5, "day").format("YYYY-MM-DD"), ddlDate: today.add(50, "day").format("YYYY-MM-DD"), extendedDdlDate: null, extensions: [], notes: "HDMI TX", chipTagIds: [chipTags[2].id], status: "in_progress", isDemo: true, createdAt: now, updatedAt: now },
  ];
